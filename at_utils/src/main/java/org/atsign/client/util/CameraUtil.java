...
/**
 * 5/10/2022 Author: Kumar Aggarrwal
 * <p>
 * CameraUtil
 * <p>
 * This Utility class can be used to capture a stream from the camera and get the result in list of
 * byte[] OR capture a single image from camera into byte[] Camera name can be provided to chose
 * which camera would be used to capture.
 * <p>
 * usage: CameraUtil.getCameraStream(); //For DefaultCamera CameraUtil.getCameraStream(String
 * cameraName); for a specific camera CameraUtil.getCaptureSingleImage(); //For DefaultCamera
 * CameraUtil.getCaptureSingleImage(String cameraName); //For a specific camera
 * <p>
 * //example for camera Name: "Webcam HD Webcam: HD Webcam /dev/video0" //Check you system drivers
 * to identify camera name or use getAllCams method here
 */
