...
will give you the best overview of how to use the library as a whole. There are five CLIs in the initial commit:

* **Activate** - generate keys for a new @-sign. If you already have a .keys file, you can reuse it.
