...
public abstract class RegisterApiTask<V> {
   ...
   *
   * @param params map that contains necessary data to complete atsign registration process
   * @param registerUtil shared utility class object containing necessary methods to complete
   *        registration
   */
  ...
  /**
   * Child classes need to implement required logic in this method to complete their sub-process in
   * the AtSign registration process
   *
   * @return {@link #result} object with necessary information collected in the corresponding API call
   */
