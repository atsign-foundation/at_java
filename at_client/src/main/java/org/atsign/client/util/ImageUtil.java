 ...
 * ImageUtil
 *
 * This utility class can be used to convert buffered image to byte[] and vice versa, it can also be
 * used to save image to memory Image format and file location can be provided, default format is
 * 'jpg' and default location would be classpath
 *
 */
