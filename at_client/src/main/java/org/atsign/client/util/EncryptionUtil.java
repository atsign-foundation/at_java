...
public class EncryptionUtil {
	...
	public static String aesEncryptToBase64(String clearText, String keyBase64)
	...
	/**
	 * Generated aes key with a given key size. if a null is passed generates a key
	 * with a default size of 256 bits
	 * 
	 * @param keysize
	 * @return
	...
	public static String signSHA256RSA(String input, PrivateKey pk) throws Exception {
	...
	public static PrivateKey privateKeyFromBase64(String s) throws NoSuchAlgorithmException, InvalidKeySpecException {
	...
	// non-public methods
	static PublicKey publicKeyFromBase64(String s) throws NoSuchAlgorithmException, InvalidKeySpecException {
		byte[] keyBytes = Base64.getDecoder().decode(s.getBytes(StandardCharsets.UTF_8));
