...
public class GetAtKeysSteps {
    ...
    public void assertGetAtKeysMatches(Integer ordinal, AtSign clientAtSign, String regex, DataTable expected) throws Exception {
    ...
    public void assertGetAtKeysContains(Integer ordinal, AtSign clientAtSign, String regex, DataTable expected) throws Exception {
        AtClient atClient = context.lookupAtClient(clientAtSign, ordinal);
    ...
    public void assertGetAtKeysNotContains(Integer ordinal, AtSign clientAtSign, String regex, DataTable notExpected) throws Exception {
        AtClient atClient = context.lookupAtClient(clientAtSign, ordinal);
