...
public class PublicAtKeySteps {
    ...
    public void getAsNonOwner(Integer ordinal, AtSign clientAtSign, String name, AtSign sharedBy, String expected) throws Exception {
        AtClient atClient = context.lookupAtClient(clientAtSign, ordinal);
    ...
    private void putKeyValue(AtClient atClient, AtSign sharedBy, String name, String value) throws InterruptedException, ExecutionException {
